...
namespace Reservoom.HostBuilders
{
    public static class AddViewModelsHostBuilderExtensions
    {
        ...
        private static ReservationListingViewModel CreateReservationListingViewModel(IServiceProvider serviceProvider)
        {
            HotelStore hotelStore = serviceProvider.GetRequiredService<HotelStore>();
            NavigationService<MakeReservationViewModel> navigationService = serviceProvider.GetRequiredService<NavigationService<MakeReservationViewModel>>();

            return ReservationListingViewModel.LoadViewModel(hotelStore, navigationService);
        }
    }
}